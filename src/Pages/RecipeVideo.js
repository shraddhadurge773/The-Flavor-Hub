        ...
        <div className='row'>
            {videos.map((video) => (
                <div key={video.idMeal} className="recipe">
                    <div className='recipeVideo_text' style={{position:"relative", display:"inline-block",width:"100%",backgroundImage:`url(${video.strMealThumb})`}}>
                    <h1 style={{position:"absolute",top:"35%",left:"39%",fontWeight:"bold"}}>{video.strMeal}</h1>
                        {/* <img src={video.strMealThumb} className="card-img-top" alt={video.strMeal} style={{minHeight:"100%", width:"100%"}} /> */}
                        <div className='mt-3' style={{position:"absolute", top:"50%", left:"50%"}}>
                            {/* <p>{video.strMeal}</p> */}
